...
export default function Swap() {
  ...
  const blockchainProvider = new BlockfrostProvider(
    "preprodbHX4xYpLqS3qeKfrApthyHCMIgH0pvbb"
  );
  ...
  const submitSwap = async (event) => {
    ...
    try {
      const tx1 = await contract.initiateSwap(
        [assetToProvide],
        [assetToReceive]
      );
      ...
      if (utxo1) {
        ...
        console.error(
          "UTxO no encontrado. No se puede continuar con la transacción."
        );
      }
    } catch (error) {
        ...
        <section className="text-black body-font lg:pt-20">
          <div className="container flex flex-col items-center justify-center py-8 mx-auto rounded-lg md:p-1 p-3 ">
            <section className="text-gray-600 body-font ">
              <form onSubmit={submitSwap} className="max-w-sm mx-auto">
                <div className="mb-5">
                ...
                <div className="mb-5">
                  <input
                    type="text"
                    onChange={(e) => {
                      setQuantityFrom(e.target.value);
                    }}
                    className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
